	...
	return (
		<div className="relative">
			...
			<button
				type="button"
				onClick={onClickPlus}
				className="-translate-y-1/2 absolute top-1/2 right-1 w-7 cursor-pointer rounded-sm p-1.5 px-2 hover:bg-gray-200"
			>
			...
			<button
				...
				className="-translate-y-1/2 absolute top-1/2 right-8 w-7 cursor-pointer rounded-sm p-1.5 px-2 hover:bg-gray-200"
			>
